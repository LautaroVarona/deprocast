...
export const OPERATIONAL_AGENTS: OperationalAgent[] = [
  ...
  },
  {
    ...
    badge: "HITL · Ingesta financiera",
    badgeTone: "emerald",
    locations: [
      "lib/finanzas/broker.ts",
      "lib/finanzas/broker-multimodal.ts",
      "lib/finanzas/service.ts",
      "app/api/finanzas/ingest/route.ts",
      "components/finanzas/ingest-box.tsx",
      "components/finanzas/pending-approvals.tsx",
    ],
    functions: [
      "Procesar ingesta rápida desde texto, audio o captura de ticket.",
      "Extraer tipo, monto, moneda, concepto, categoría y proyecto asociado.",
      "Generar borradores pending sin persistir confirmación directa (HITL).",
  ...
  },
  {
    ...
    emoji: "📊",
    name: "Eco-Pulse",
    badge: "Determinístico · Métricas",
    badgeTone: "violet",
    locations: [
      "lib/finanzas/metrics.ts",
      "app/api/finanzas/metrics/route.ts",
      "components/finanzas/runway-vital.tsx",
      "components/finanzas/burn-pulse.tsx",
      "components/finanzas/saas-semaphore.tsx",
    ],
    functions: [
      "Calcular Runway Vital (capital ÷ burn necesarios+primarios).",
      "Comparar gasto mínimo vital vs operativo total del mes.",
      "Listar suscripciones SaaS activas del tier terciario.",
    ],
    technologies: [
      "Prisma (FinancialTransaction, FinancialCapital)",
      "lib/finanzas/metrics.ts",
    ],
    uiRoute: "/finanzas",
  },
  {
    id: "reclutador-misiones",
    emoji: "🃏",
    name: "Reclutador de Misiones",
    badge: "Deck · Cartas",
    badgeTone: "violet",
    locations: [
      "lib/calendario/deck.ts",
      "app/api/calendario/deck/route.ts",
      "components/temporal/suggestion-deck.tsx",
    ],
    functions: [
      ...
      "Priorizar microtareas ≤15 min y peso de gravedad 1–12.",
      "Hook tipado para marcadores universitarios y hackathons (futuro).",
      "Sincronizar deck con universo Babel activo.",
    ],
    technologies: [
      "Prisma (PendingTask, LudusMicrotask, ContextEvent)",
      "lib/calendario/deck.ts",
      "hooks/use-temporal-data.ts",
    ],
    uiRoute: "/calendario",
  ...
  {
    id: "coagulador-jornada",
    emoji: "⚗️",
    name: "Coagulador de Jornada",
    badge: "Draft · HITL",
    badgeTone: "cyan",
    locations: [
      "lib/calendario/coagulate.ts",
      "app/api/calendario/coagulate/route.ts",
      "app/api/calendario/blocks/[id]/route.ts",
      "components/calendario/calendario-workspace.tsx",
    ],
    functions: [
      "Materializar cartas del mazo en slots temporales (coagulación).",
      "Transición visual glow Noir y preview de Puntos de Señal anticipados.",
      "Actualizar executionStatus de rutinas (confirmar / saltear / ejecutado).",
      "Invalidar Calendario y Campamento vía bumpTemporal() tras cada cambio.",
      "Bloquear DnD de infraestructura IMMUTABLE salvo confirmación explícita.",
    ],
    technologies: [
      "Prisma (ContextEvent)",
      "lib/calendario/coagulate.ts",
      "BabelProvider (bumpTemporal)",
      "HTML5 Drag and Drop",
    ],
    uiRoute: "/calendario",
  },
  ...
  },
  {
    ...
    locations: [
      ...
      "lib/calendario/service.ts",
      "hooks/use-temporal-data.ts",
      "app/api/temporal/range/route.ts",
      "app/api/calendario/route.ts",
      "components/babel/babel-context.tsx",
      "components/temporal/week-grid.tsx",
    ],
    functions: [
      ...
      "Exponer rangos semanales y mensuales para el planificador compartido components/temporal.",
      "Filtrar eventos por universo activo y ecosystemArea manteniendo telemetría de salud global.",
    ],
    technologies: [
  ...
  },
  {
    ...
    locations: [
      ...
      "components/temporal/week-grid.tsx",
      "components/temporal/month-board.tsx",
      "components/temporal/block-chip.tsx",
      "components/ludus/campamento/quick-ideas-panel.tsx",
      "app/ludus/campamento/page.tsx",
    ],
    functions: [
      "Renderizar vista semanal de 7 días con bloques compartidos components/temporal.",
      "Alternar a vista mensual de control con densidad de actividad y bosses.",
      "Permitir drag & drop de tareas y eventos entre días de la semana.",
      "Crear ideas rápidas en transición vía POST /api/pendientes.",
      "Sincronizar cambios al instante con /calendario vía Orquestador Temporal y bumpTemporal.",
    ],
    technologies: [
      "HTML5 Drag and Drop",
      "hooks/use-temporal-data.ts",
