    ...
    <div className="space-y-5">
      <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
        <p>
          ...
          <span className="text-accent/90">diferencia entre ambas</span> y
          genera una percepción interna llamada frecuencia de batido.
        </p>
        <p>
          Ese cálculo diferencial puede inducir un fenómeno de{" "}
          <span className="text-primary/90">arrastre neural</span>{" "}
      ...
      <div
        role="alert"
        className="flex gap-3 rounded-lg border border-accent/40 bg-accent/10 px-4 py-3"
      >
        <HeadphonesIcon
          className="mt-0.5 size-5 shrink-0 text-accent"
          aria-hidden
        />
        <p className="font-mono text-xs leading-relaxed text-accent/90">
