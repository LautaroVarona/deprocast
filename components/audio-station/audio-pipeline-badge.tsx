...
const STAGE_STYLES: Record<AudioPipelineInfo["stage"], string> = {
  pending_stt: "border-white/15 bg-white/5 text-white/50",
  stt_queued: "border-sky-500/25 bg-sky-500/10 text-sky-200/80",
  stt_processing: "border-amber-500/30 bg-amber-500/10 text-amber-200/90",
  stt_error: "border-red-500/30 bg-red-500/10 text-red-200/90",
  pending_purify: "border-violet-500/30 bg-violet-500/10 text-violet-200/90",
