  ...
  return (
    <section className="space-y-6">
      <div className="flex items-center gap-2">
        <CpuIcon className="size-4 text-zinc-500" aria-hidden />
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-zinc-800 hover:bg-transparent">
              <TableHead className="text-zinc-500">Estación</TableHead>
              <TableHead className="text-zinc-500">Componente</TableHead>
              <TableHead className="hidden text-zinc-500 md:table-cell">
                Función
              </TableHead>
              <TableHead className="text-zinc-500">Ubicación</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {SUBPROCESSORS.map((item) => (
              ...
              >
                <TableCell className="font-mono text-xs text-cyan-400/90">
                  {item.station}
                </TableCell>
                <TableCell className="text-sm text-zinc-200">
                  {item.name}
                </TableCell>
                <TableCell className="hidden max-w-xs text-xs text-zinc-500 md:table-cell">
                  {item.description}
                </TableCell>
      ...
      <div className="flex items-center gap-2">
        <DatabaseIcon className="size-4 text-zinc-500" aria-hidden />
